...
- [x] **伏笔管理** - 智能追踪剧情伏笔，提醒未回收线索，AI 生成时自动注入伏笔上下文
- [x] **一致性检测** - AI 分析角色行为一致性和剧情连贯性，提供改进建议
- [x] **时间线管理** - 故事事件时间轴追踪，支持按章节、类型筛选
- [x] **风格分析** - 学习项目写作风格，生成风格指南供 AI 参考
- [x] **章节质量评分** - 基础指标 + AI 综合评估，返回分数和改进建议
- [x] **重复内容检测** - 检测章节内部和章节间的重复/相似内容
- [x] **角色成长轨迹** - 追踪角色能力、关系、心理、状态变化
